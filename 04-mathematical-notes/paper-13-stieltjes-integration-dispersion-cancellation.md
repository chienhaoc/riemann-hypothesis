...
$$\langle \mathrm{Re}\mathcal{C}_2 \rangle_T = -\frac{1}{8T} \left(\frac{1}{6}X^2 T^3\right) + \frac{X^2}{16T}\left(\frac{1}{3}T^3\right) + \mathcal{O}(X T^2) = -\frac{1}{48}X^2 T^2 + \frac{1}{48}X^2 T^2 + \mathcal{O}(X T^2) \equiv 0\cdot X^2 T^2 + \mathcal{O}(X T^2)$$
